...
namespace Ccom.Pharmacy {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("InvoiceDbDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class InvoiceDbDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected InvoiceDbDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            InvoiceDbDataSet cln = ((InvoiceDbDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "InvoiceDbDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/InvoiceDbDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            InvoiceDbDataSet ds = new InvoiceDbDataSet();
        ...
        public partial class InvoiceDataTable : global::System.Data.TypedTableBase<InvoiceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InvoiceRow AddInvoiceRow(System.DateTime Date, string Description, string InvoiceNo, double TotalAmount, double Cash, double Balance, double Discount, double SubAmount) {
            ...
            private void InitClass() {
                ...
                this.columnSubAmount.AllowDBNull = false;
            }
        ...
        public partial class InvoiceRow : global::System.Data.DataRow {
            ...
            public double Balance {
                get {
                    return ((double)(this[this.tableInvoice.BalanceColumn]));
                }
                set {
            ...
            public double SubAmount {
                get {
                    return ((double)(this[this.tableInvoice.SubAmountColumn]));
                }
                set {
...
namespace Ccom.Pharmacy.InvoiceDbDataSetTableAdapters {
    ...
    public partial class InvoiceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Invoice] WHERE (([Id] = @Original_Id) AND ([Date] = @Original_Date) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)) AND ((@IsNull_InvoiceNo = 1 AND [InvoiceNo] IS NULL) OR ([InvoiceNo] = @Original_InvoiceNo)) AND ([TotalAmount] = @Original_TotalAmount) AND ([Cash] = @Original_Cash) AND ([Balance] = @Original_Balance) AND ([Discount] = @Original_Discount) AND ([SubAmount] = @Original_SubAmount))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_SubAmount", global::System.Data.SqlDbType.Float, 0, global::System.Data.ParameterDirection.Input, 0, 0, "SubAmount", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Invoice] ([Date], [Description], [InvoiceNo], [TotalAmount], [Cash], [Balance], [Discount], [SubAmount]) VALUES (@Date, @Description, @InvoiceNo, @TotalAmount, @Cash, @Balance, @Discount, @SubAmount);
SELECT Id, Date, Description, InvoiceNo, TotalAmount, Cash, Balance, Discount, SubAmount FROM Invoice WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@SubAmount", global::System.Data.SqlDbType.Float, 0, global::System.Data.ParameterDirection.Input, 0, 0, "SubAmount", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Invoice] SET [Date] = @Date, [Description] = @Description, [InvoiceNo] = @InvoiceNo, [TotalAmount] = @TotalAmount, [Cash] = @Cash, [Balance] = @Balance, [Discount] = @Discount, [SubAmount] = @SubAmount WHERE (([Id] = @Original_Id) AND ([Date] = @Original_Date) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)) AND ((@IsNull_InvoiceNo = 1 AND [InvoiceNo] IS NULL) OR ([InvoiceNo] = @Original_InvoiceNo)) AND ([TotalAmount] = @Original_TotalAmount) AND ([Cash] = @Original_Cash) AND ([Balance] = @Original_Balance) AND ([Discount] = @Original_Discount) AND ([SubAmount] = @Original_SubAmount));
SELECT Id, Date, Description, InvoiceNo, TotalAmount, Cash, Balance, Discount, SubAmount FROM Invoice WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@SubAmount", global::System.Data.SqlDbType.Float, 0, global::System.Data.ParameterDirection.Input, 0, 0, "SubAmount", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_SubAmount", global::System.Data.SqlDbType.Float, 0, global::System.Data.ParameterDirection.Input, 0, 0, "SubAmount", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ccom.Pharmacy.Properties.Settings.Default.PharmacyDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Date, Description, InvoiceNo, TotalAmount, Cash, Balance, Discount, Su" +
                "bAmount FROM dbo.Invoice";
        ...
        public virtual int Fill(InvoiceDbDataSet.InvoiceDataTable dataTable) {
        ...
        public virtual InvoiceDbDataSet.InvoiceDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InvoiceDbDataSet.InvoiceDataTable dataTable = new InvoiceDbDataSet.InvoiceDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InvoiceDbDataSet.InvoiceDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InvoiceDbDataSet dataSet) {
        ...
        public virtual int Delete(int Original_Id, System.DateTime Original_Date, string Original_Description, string Original_InvoiceNo, double Original_TotalAmount, double Original_Cash, double Original_Balance, double Original_Discount, double Original_SubAmount) {
            ...
            if ((Original_InvoiceNo == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_InvoiceNo));
            }
            this.Adapter.DeleteCommand.Parameters[6].Value = ((double)(Original_TotalAmount));
            this.Adapter.DeleteCommand.Parameters[7].Value = ((double)(Original_Cash));
            ...
            this.Adapter.DeleteCommand.Parameters[10].Value = ((double)(Original_SubAmount));
        ...
        public virtual int Insert(System.DateTime Date, string Description, string InvoiceNo, double TotalAmount, double Cash, double Balance, double Discount, double SubAmount) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((double)(Cash));
            ...
            this.Adapter.InsertCommand.Parameters[7].Value = ((double)(SubAmount));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(Cash));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((double)(Balance));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((double)(Discount));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((double)(SubAmount));
            ...
            this.Adapter.UpdateCommand.Parameters[14].Value = ((double)(Original_TotalAmount));
            this.Adapter.UpdateCommand.Parameters[15].Value = ((double)(Original_Cash));
            ...
            this.Adapter.UpdateCommand.Parameters[18].Value = ((double)(Original_SubAmount));
        ...
        public virtual int Update(
                    ...
                    double Original_Discount, 
                    double Original_SubAmount) {
            return this.Update(Date, Description, InvoiceNo, TotalAmount, Cash, Balance, Discount, SubAmount, Original_Id, Original_Date, Original_Description, Original_InvoiceNo, Original_TotalAmount, Original_Cash, Original_Balance, Original_Discount, Original_SubAmount, Original_Id);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(InvoiceDbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._invoiceTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(InvoiceDbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._invoiceTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(InvoiceDbDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._invoiceTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(InvoiceDbDataSet dataSet) {
            if ((dataSet == null)) {
